...
{
    public static class HttpStatusCodeMsg
    {

        public  const string ContinueMsg = "Continue indicates that the client can continue with its request";
        public const string BadRequestMsg = "BadRequest is sent when no other error is applicable, or if the exact error is unknown or does not have its own error code.";

        //public enum HttpStatusCodeMsg
        //{
        //    //
        //    // Summary:
